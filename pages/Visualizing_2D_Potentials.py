...
if pot_fxn == "Two Power Spherical Potential":
	...
	pot_fxn_set = galpy.potential.HomogeneousSpherePotential(R = param1)
	...
	param1 = st.slider("Scale Radius, " + r"$a$", min_value = 1, max_value = 50)*units.kpc
...
plot_orbit_2D(pot_fxn_set, years)
